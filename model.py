...
class PixelCNN(nn.Module):
    def __init__(self, nr_resnet=5, nr_filters=80, nr_logistic_mix=10,
        ...
        # Add a final 1x1 convolution layer before outputting
        # This can help in better mixing the feature maps before the final prediction.
        self.final_conv = nin(nr_filters, nr_filters)
